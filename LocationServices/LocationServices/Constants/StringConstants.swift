...
enum StringConstant {
    ...
    static let arrivalCardTitle = "You've arrived!"
    static let poiCardSchedule = "Schedule"
    static let language = "Language"
    static let politicalView = "Political view"
    static let mapRepresentation = "Map representation for different countries"
    static let mapLanguage = "Map Language"
    static let selectLanguage = "Select Language"
    static let leaveNow = "Leave now"
    static let leaveAt = "Leave at"
