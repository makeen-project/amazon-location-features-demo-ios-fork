...
enum StringConstant {
    ...
    static let search = LanguageManager.shared.localizedString(forKey:"Search")
    static let searchDestination = LanguageManager.shared.localizedString(forKey:"Search Destination")
    static let searchStartingPoint = LanguageManager.shared.localizedString(forKey:"Search starting Point")
    static let noMatchingPlacesFound = LanguageManager.shared.localizedString(forKey: "No matching places found")
    static let searchSpelledCorrectly = LanguageManager.shared.localizedString(forKey: "Make sure your search is spelled correctly. Try adding a city, postcode, or country.")
    ...
    static let welcomeTitle = LanguageManager.shared.localizedString(forKey:"Welcome to Amazon Location Demo")
    ...
    static let avoidUturns = LanguageManager.shared.localizedString(forKey:"Avoid U-turns")
