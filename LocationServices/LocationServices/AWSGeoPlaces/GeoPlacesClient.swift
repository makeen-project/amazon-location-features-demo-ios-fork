...
extension GeoPlacesClient {
    ...
    /// - `InternalServerException` : [no documentation found]
    /// - `ThrottlingException` : [no documentation found]
    /// - `ValidationException` : [no documentation found]
