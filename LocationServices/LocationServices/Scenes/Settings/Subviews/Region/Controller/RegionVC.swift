...
final class RegionVC: UIViewController {
    var selectedCell: Int = 0
    var viewModel: RegionSceneViewModelProcotol! {
        didSet {
    ...
    private var screenTitleLabel: UILabel = {
        ...
        label.font = .amazonFont(type: .bold,
                                 size: 20)
        label.text = StringConstant.region
        return label
    }()
    ...
    private func setupView() {
        ...
        self.navigationItem.title = StringConstant.region
...
extension RegionVC: RegionSceneViewModelOutputDelegate {
